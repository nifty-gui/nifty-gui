 ...
 * @author void
 */
/* package */ class LayoutAbsolute implements Layout {
   ...
   */
  public LayoutAbsolute(final PostProcess post) {
    this.post = post;
  }

  /**
   * layoutElements.
   * @param rootElement @see {@link Layout}
   * @param elements @see {@link Layout}
   */
  @Override
