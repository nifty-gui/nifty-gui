 ...
 * tolerance - see {@link #BatchRenderDevice(de.lessvoid.nifty.batch.spi.BatchRenderBackend, BatchRenderConfiguration)}.
...
public class BatchRenderDevice implements RenderDevice {
   ...
   * {@link de.lessvoid.nifty.batch.BatchRenderConfiguration}, which should be fine for simple uses (including the
