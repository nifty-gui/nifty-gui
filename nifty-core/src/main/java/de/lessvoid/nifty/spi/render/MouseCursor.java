...
/**
 * A MouseCursor Handle ready to be applied as the current mouse cursor of the window. This represents a loaded
 * MouseCursor resource ready to be applied using {@link NiftyMouse}.
 *
 * @author void
 */
