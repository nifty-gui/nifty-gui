 ...
 * @author void
 */
/* package */ class NiftyColorStringParser {
  private static Logger log = Logger.getLogger(NiftyColorStringParser.class.getName());

  /**
   * ColorValidator.
   */
  private static NiftyColorValidator colorValidator = new NiftyColorValidator();
   ...
   */
  NiftyColor fromString(final String color) {
    float red = 1.f;
    float green = 1.f;
    float blue = 1.f;
    float alpha = 1.f;
