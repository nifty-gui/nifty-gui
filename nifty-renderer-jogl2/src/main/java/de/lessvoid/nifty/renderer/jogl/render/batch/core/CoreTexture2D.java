...
public class CoreTexture2D {
  ...
  public enum ResizeFilter {
     ...
     */
    NearestMipMapNearest(GL.GL_NEAREST_MIPMAP_NEAREST, GL.GL_NEAREST),
     ...
     * quality.
     */
    NearestMipMapLinear(GL.GL_NEAREST_MIPMAP_LINEAR, GL.GL_LINEAR),
     ...
     * quality.
     */
    LinearMipMapNearest(GL.GL_LINEAR_MIPMAP_NEAREST, GL.GL_LINEAR),
     ...
     */
    LinearMipMapLinear(GL.GL_LINEAR_MIPMAP_LINEAR, GL.GL_LINEAR);
  ...
  public enum ColorFormat {
     ...
     */
    Red(GL3.GL_RED, GL.GL_RGB, GL3.GL_COMPRESSED_RGB),

    /**
     * In case this format is used the pixel data is expected to contain only one color channel. This color channel is
     * used as the <b>green</b> color of the newly created RGB texture.
     */
    Green(GL3.GL_GREEN, GL.GL_RGB, GL3.GL_COMPRESSED_RGB),

    /**
     * In case this format is used the pixel data is expected to contain only one color channel. This color channel is
     * used as the <b>blue</b> color of the newly created RGB texture.
     */
    Blue(GL3.GL_BLUE, GL.GL_RGB, GL3.GL_COMPRESSED_RGB),
     ...
     */
    RGB(GL.GL_RGB, GL.GL_RGB, GL3.GL_COMPRESSED_RGB),

    /**
     * In case this format is used the pixel data is expected to contain three color channels. The colors are
     * <b>blue</b>, <b>green</b> and <b>red</b> in this order. The created texture will be a RGB texture.
     */
    BGR(GL3.GL_BGR, GL.GL_RGB, GL3.GL_COMPRESSED_RGB),
     ...
     */
    RGBA(GL.GL_RGBA, GL.GL_RGBA, GL3.GL_COMPRESSED_RGBA),

    /**
     * In case this format is used the pixel data is expected to contain four color channels. The colors are
     * <b>blue</b>, <b>green</b>, <b>red</b> and <b>alpha</b> in this order. The created texture will be a RGBA texture.
     */
    BGRA(GL3.GL_BGRA, GL.GL_RGBA, GL3.GL_COMPRESSED_RGBA);
  ...
  public static boolean isNPOTSupported() {
    final GL gl = GLContext.getCurrentGL();
    return gl.isGL3() || isNPOTHardwareSupported();
  }
  ...
  private static void checkFormatSizeData(final int format, final int type, @Nullable final Buffer data) {
    ...
    switch (type) {
      ...
      case GL.GL_BYTE:
      case GL3.GL_UNSIGNED_BYTE_3_3_2:
      case GL3.GL_UNSIGNED_BYTE_2_3_3_REV:
      ...
      case GL.GL_SHORT:
      case GL3.GL_UNSIGNED_SHORT_5_6_5:
      case GL3.GL_UNSIGNED_SHORT_5_6_5_REV:
      case GL3.GL_UNSIGNED_SHORT_4_4_4_4:
      case GL3.GL_UNSIGNED_SHORT_4_4_4_4_REV:
      case GL3.GL_UNSIGNED_SHORT_5_5_5_1:
      case GL3.GL_UNSIGNED_SHORT_1_5_5_5_REV:
      ...
      case GL3.GL_INT:
      case GL3.GL_UNSIGNED_INT_8_8_8_8:
      case GL3.GL_UNSIGNED_INT_8_8_8_8_REV:
      case GL3.GL_UNSIGNED_INT_10_10_10_2:
  ...
  public void updateTextureData(final Buffer pixels) {
    ...
    if (pixels instanceof ByteBuffer) {
      gl.glTexImage2D(texImageTarget, texImageLevel, texImageInternalFormat, texImageWidth, texImageHeight,
          texBorder, texFormat, texType, pixels);
  ...
  private static void gluBuild2DMipmaps(
    ...
    if (data instanceof ByteBuffer) {
      ...
      glu.gluBuild2DMipmaps(target, components, width, height, format, type, data);
