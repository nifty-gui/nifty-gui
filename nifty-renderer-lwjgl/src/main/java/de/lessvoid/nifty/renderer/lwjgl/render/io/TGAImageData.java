...
public class TGAImageData implements ImageData {
  ...
  @Override
  public ByteBuffer loadMouseCursorImage(@Nonnull InputStream fis) throws IOException {
    return loadImageInternal(fis, true, false, null, false, true);
  }

  @Override
  public ByteBuffer loadImageDirect(@Nonnull InputStream fis) throws IOException {
