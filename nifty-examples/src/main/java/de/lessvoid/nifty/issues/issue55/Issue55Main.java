...
public class Issue55Main {
  ...
  public static void main(final String[] args) {
    if (!LwjglInitHelper.initSubSystems("Issue 55")) {
      System.exit(0);
    }
  ...
  public static class MyScreenController extends DefaultScreenController {
    ...
    public void onMouse(final String id, @Nonnull final NiftyMousePrimaryClickedEvent event) {
      // without the fix you would get this twice
      System.out.println("you should see this line only once when you click! " + event.getMouseX() + ", " + event.getMouseY());
    }
  }
}
