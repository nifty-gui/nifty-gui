...
public class RenderDeviceJava2dImpl implements RenderDevice {
  ...
  public void renderImage(
      @Nonnull RenderImage image, int x, int y, int width,
      int height, @Nonnull Color color, float imageScale) {
  ...
  @Override
  public void renderImage(
      @Nonnull RenderImage image, int x, int y, int w, int h,
      int srcX, int srcY, int srcW, int srcH, @Nonnull Color color, float scale,
  ...
  public void renderQuad(
      int x, int y, int width, int height, @Nonnull Color topLeft,
      @Nonnull Color topRight, @Nonnull Color bottomRight, @Nonnull Color bottomLeft) {
    graphics.setClip(clipRectangle);
  ...
  public void renderFont(
      @Nonnull RenderFont font, @Nonnull String text, int x, int y,
    ...
    if (font instanceof RenderFontJava2dImpl) {
      ...
      @SuppressWarnings("deprecation") AngelCodeFont angelCodeFont = renderFont.getAngelCodeFont();
      ...
      for (int i = 0; i < text.length(); i++) {
        ...
        //char nextCharacter = i + 1 < text.length() ? text.charAt(i + 1) : 0;

        @SuppressWarnings("deprecation") CharacterInfo charInfo = angelCodeFont.getChar(c);
  ...
  private void renderFontJava2dImpl(
      String text, int x, int y,
      @Nonnull Color fontColor, @Nonnull RenderFontJava2dImpl font) {
    graphics.setClip(clipRectangle);
