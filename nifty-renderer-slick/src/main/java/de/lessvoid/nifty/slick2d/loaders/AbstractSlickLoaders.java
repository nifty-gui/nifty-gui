...
public abstract class AbstractSlickLoaders<T extends SlickLoader> {
    ...
    /**
     * Check if the resource loader that is about to be added already a part of the
     ...
     * automatically in case resources are requested but no loaders got registered.
