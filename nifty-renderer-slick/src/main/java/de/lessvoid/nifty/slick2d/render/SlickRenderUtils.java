...
public final class SlickRenderUtils {
     ...
     * @param niftyColor the Nifty color that is supposed to store the values of
     *            the Slick color
    ...
    public static de.lessvoid.nifty.tools.Color convertColorSlickNifty(
        final org.newdawn.slick.Color slickColor) {
        return new de.lessvoid.nifty.tools.Color(slickColor.r, slickColor.g,
            slickColor.b, slickColor.a);
    }
     ...
     * @param slickColor the instance of a Slick color that is supposed to store
     *            the color values
    ...
    public static org.newdawn.slick.Color convertColorNiftySlick(
        final de.lessvoid.nifty.tools.Color niftyColor) {
        return new org.newdawn.slick.Color(niftyColor.getRed(),
            niftyColor.getGreen(), niftyColor.getBlue(), niftyColor.getAlpha());
    }
}
