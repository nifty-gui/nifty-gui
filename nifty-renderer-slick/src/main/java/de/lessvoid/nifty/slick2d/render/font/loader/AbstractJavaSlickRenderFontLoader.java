 ...
 */
public abstract class AbstractJavaSlickRenderFontLoader implements
    SlickRenderFontLoader {
    /**
     * Load the file that is named in the String as a Java Font assuming the
     * font is of the defined type.
     * 
     ...
     * possible.
     * 
     * @param font the String that defines the file that is supposed to be load
     *            as font
     * @return the loaded font or <code>null</code> in case loading the font
     *         failed
     */
