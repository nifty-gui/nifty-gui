...
public interface SlickRenderImage extends RenderImage {
     ...
     * @param scale scaling factor that is applied to the image, the image is
     *            scaled around the center of the image
     */
    void renderImage(Graphics g, int x, int y, int width, int height, Color color,
        float scale);
     ...
     */
    void renderImage(Graphics g, int x, int y, int w, int h, int srcX, int srcY, int srcW,
