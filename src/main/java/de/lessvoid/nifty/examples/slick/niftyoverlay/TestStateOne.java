...
/**
 * The first Slick test GameState that has a Nifty overlay
 ...
 *
 */
public class TestStateOne extends NiftyOverlayGameState {
	...
	public void xmlLoader() {
		...
		setXML("data/ui/multiOverlay.xml", "screen1", new TestStateOne.Controller());
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
	    ...
	    g.drawString("1-3 will switch between colors", 100, 250);
	    g.drawString("a-c will switch between images", 100, 300);
	    g.drawString("(this is all slick rendering!)", 100, 350);
	    g.drawString("space toggles the Nifty overlay on/off", 100, 420);
	    g.drawString("F1 switches between GameStates", 100, 470);
	    g.drawString("(F2 switches screens in a GameState)", 100, 520);
	...
	// for this example: switch the Nifty test icons upon request
	...
	// for this example: fire off a Nifty effect
