...
public class ConsoleControl implements Controller {
  ...
  public void onStartScreen(final Screen newScreen) {
    ...
    for (int i = 0; i < lines; i++) {
      ...
      attr.setName("console-line");
      attr.setId("console-line-" + i);
      attr.createControl(nifty, screen, element);
//      this.nifty.addControl(screen, element, "console-line", "console-line-" + i, null, null, null);
    }
    StandardAttributes attr = new StandardAttributes();
    attr.setName("textfield");
    attr.setId("console-input");
    attr.setAttribute("style", "nifty-console-textfield");
    attr.createControl(nifty, screen, element);
