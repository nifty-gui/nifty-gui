...
public class ScrollPanel extends AbstractController {
    ...
    public void initializeScrollPanel(final Screen screen, final float stepSizeX,
        ...
        if (childRootElement != null) {
            ...
            if (scrollElement != null) {
                horizontalS = element.findControl("nifty-internal-horizontal-scrollbar",
                ...
                verticalS = element.findControl("nifty-internal-vertical-scrollbar",
                ...
                scrollElement.addElementChangeListener(new ElementChangeListener() {
                    ...
                    public void elementChanged(Element element) {
                        horizontalS = ScrollPanel.this.element.findControl(
                                "nifty-internal-horizontal-scrollbar",
                                HorizontalScrollbarControl.class);
                        verticalS = ScrollPanel.this.element
                                .findControl("nifty-internal-vertical-scrollbar",
                                        VerticalScrollbarControl.class);
                        if (horizontalS != null
                                && horizontalS.getWorldMaxValue() != element.getWidth()) {
                            updateWorldH();
                        }
                        if (verticalS != null
                                && verticalS.getWorldMaxValue() != element.getHeight()) {
                            updateWorldV();
                        }
                    }
                });
    ...
    /**
     * sets the vertical position so you see the specified element (elemCount) For that stepSizeY
     * have to be exactly the height of one element
     * 
     * @param elemCount
     */
    ...
    /**
     * sets the vertical position so you see the specified element (elemCount) you can choose
     * between three different vertical alignments (top,middle,bottom) For that function to work
     * stepSizeY have to be exactly the height of one element
     * 
     * @param elemCount
    ...
    /**
     * Sets the automatic scrolling of the scroll panel when the underlying element changes size
     * 
